...
class ASAspectRatio {
  ...
  const ASAspectRatio({required this.title, this.ratio});
}
...
class CropOption {
  ...
  final List<ASAspectRatio> ratios;

  const CropOption({
    this.reversible = true,
    this.ratios = const [
      ASAspectRatio(title: 'Freeform'),
      ASAspectRatio(title: '1:1', ratio: 1),
      ASAspectRatio(title: '4:3', ratio: 4 / 3),
      ASAspectRatio(title: '5:4', ratio: 5 / 4),
      ASAspectRatio(title: '7:5', ratio: 7 / 5),
      ASAspectRatio(title: '16:9', ratio: 16 / 9),
    ],
  });
}
