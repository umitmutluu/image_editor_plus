...
import 'package:image_editor_plus/signature/utils.dart';
...
class HandSignatureControl extends ChangeNotifier {
 ...
 final  double threshold;
  ...
  String? toSvg({
    ...
    params ??= const SignaturePaintParams(
      color: Colors.black,
      strokeWidth: 1.0,
      maxStrokeWidth: 10.0,
    );
